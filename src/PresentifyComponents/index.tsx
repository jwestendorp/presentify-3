...
let WebviewIconFrame = ({ children }) => (
  <div className="flex items-center justify-center p-0 rounded">{children}</div>
);

type Tool = {
  icon: React.ReactNode;
  name: string;
  default_options?: Record<string, any>; // to be updated
  Component: (props: { options: Record<string, any> }) => React.ReactNode;
  ConfigScreen?: (props: {
